...
class SearchViewCompatHoneycomb {
    ...
    static class C00471 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00471(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00482 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00482(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
