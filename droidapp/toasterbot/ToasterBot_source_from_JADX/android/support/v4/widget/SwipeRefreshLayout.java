...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C01103 extends BaseAnimationListener {
        C01103() {
            super(null);
        }
    ...
    class C01114 extends BaseAnimationListener {
        C01114() {
            super(null);
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mReturnToStartPositionListener = new C01103();
        this.mShrinkAnimationListener = new C01114();
