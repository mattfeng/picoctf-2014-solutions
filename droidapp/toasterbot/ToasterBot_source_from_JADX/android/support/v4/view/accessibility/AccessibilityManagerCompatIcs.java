...
class AccessibilityManagerCompatIcs {
    ...
    static class C00371 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00371(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
