...
import picoapp453.picoctf.com.picoapp.BuildConfig;
...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    class C01121 implements VisibilityListener {
        C01121() {
        }
    ...
    String getShortcutLabel() {
        ...
        switch (shortcut) {
            case HIDDEN /*8*/:
                ...
                break;
            case C0090R.styleable.MenuItem_android_numericShortcut /*10*/:
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        if (this.mActionProvider != actionProvider) {
            ...
            if (actionProvider != null) {
                actionProvider.setVisibilityListener(new C01121());
            }
        }
        return this;
    }
