...
public class ActionBarView extends AbsActionBarView {
    ...
    class C01141 implements OnItemSelectedListener {
        C01141() {
        }
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        this.mNavItemSelectedListener = new C01141();
        this.mExpandedActionViewUpListener = new C00662();
        this.mUpClickListener = new C00673();
        this.mContext = context;
        setBackgroundResource(DISPLAY_DEFAULT);
        TypedArray a = context.obtainStyledAttributes(attrs, C0059R.styleable.ActionBar, C0059R.attr.actionBarStyle, DISPLAY_DEFAULT);
