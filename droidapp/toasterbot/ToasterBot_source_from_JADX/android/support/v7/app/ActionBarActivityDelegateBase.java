...
import picoapp453.picoctf.com.picoapp.C0090R;
...
class ActionBarActivityDelegateBase extends ActionBarActivityDelegate implements Callback, MenuBuilder.Callback {
    ...
    static {
        ACTION_BAR_DRAWABLE_TOGGLE_ATTRS = new int[]{C0059R.attr.homeAsUpIndicator};
    }
    ...
    final void ensureSubDecor() {
        if (!this.mSubDecorInstalled) {
            if (this.mHasActionBar) {
                ...
                this.mActivity.superSetContentView(C0059R.layout.abc_simple_decor);
            }
            ...
            this.mActivity.getWindow().getDecorView().post(new C00581());
        }
    }
    ...
    public boolean supportRequestWindowFeature(int featureId) {
        switch (featureId) {
            ...
            case TransportMediator.FLAG_KEY_MEDIA_PLAY_PAUSE /*8*/:
                ...
                return true;
            case C0090R.styleable.Spinner_disableChildrenWhenDisabled /*9*/:
    ...
    int getHomeAsUpIndicatorAttrId() {
        return C0059R.attr.homeAsUpIndicator;
    }
